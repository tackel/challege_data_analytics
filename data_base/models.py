...
class Total_data(db_connection.Base):
    ...
    def __init__(self, Cod_Loc, IdProvincia,IdDepartamento,Categoria,Subcategoria,Provincia,Localidad,
    ...
    def __repr__(self):
        return (f'Total_data({self.Cod_Loc},{self.IdProvincia},{self.IdDepartamento},{self.Categoria},{self.Subcategoria},{self.Provincia},{self.Localidad},{self.Nombre},{self.Domicilio},{self.Piso},{self.CP},{self.Cod_area},{self.Telefono},{self.Mail},{self.Web},{self.Pantallas},{self.Butacas},{self.espacio_INCAA},{self.Fuente},{self.Fecha_Actualizacion})')
