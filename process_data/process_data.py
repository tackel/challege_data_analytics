...
class Process_data:
    def __init__(self):
        ...
        try:
            ...
            print('Error en las rutas de archivos csv. No fue posible leer alguno de ellos.')
            logging.erro('Error en las rutas de archivos csv. No fue posible leer alguno de ellos.')
    ...
    def normalizar_data(self):
        ...
        try:
            ...
            logging.error('No se pudieron normalizar los nombres de las columnas')
            return None, 'fail'
        try:
            ...
            logging.info('Datos Para Tabla total_data Preparados')
            
            return self.total_data_frame
        except:
            logging.error('La estructura de datos obtenidos en la utima actualizacion, difiere de la origina. Es necesario realizar cambios en la normalizacion de datos.')
            print('La estructura de datos obtenidos en la utima actualizacion, difiere de la origina. Es necesario realizar cambios en la normalizacion de datos.')
            return None, 'fail'
    ...
    def cantidades_conjuntas(self):
        ...
        try:
            ...
            print('Datos Para Tabla registros_x_categoria Preparados')
            logging.info('Datos Para Tabla registros_x_categoria Preparados')
            
            return cant_data_final
        except:
            print('No fue posible preparar los datos para tabla registros_x_categoria')
            logging.error('No fue posible preparar los datos para tabla registros_x_categoria')
    ...
    def info_cines(self):
        ...
        try:
            ...
            print('Datos Para Tabla cine_data Preparados')
            logging.info('Datos Para Tabla cine_data Preparados')
            return cine_data
        except:
            print('No fue posible preparar los datos para tabla cine_data')
            logging.error('No fue posible preparar los datos para tabla cine_data')
